...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_C', type=float, default=2.0, help='weight for AE(Gx) loss in VIGAN')
        self.parser.add_argument('--lambda_D', type=float, default=10.0, help='weight for AE loss in VIGAN')
