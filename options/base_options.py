...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', type=str, default='vigan',
                                 help='chooses which model to use. vigan, one_direction_test, ...')
        ...
        self.parser.add_argument('--display_id', type=int, default=0, help='window id of the G display')
